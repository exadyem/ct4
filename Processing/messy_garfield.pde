...
void inputDecisionSad(){
  String a1 = "happy" + "good" + "gleeful" + "cheery" + "cheerful" + "content" + "contented" + "merry" + "delighted" + "jolly" + "lucky" + "fortunate" + "fortunately" + "smiling" + "smile" + "happiness";
  for(String str: neg){
    if(str.trim().contains(a1)){
